<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Currencies.aspx.cs" Inherits="P2M_Tools.pages.Currencies" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Menu ID="Menu1" runat="server" Orientation="Horizontal" CssClass="tab" StaticMenuItemStyle-CssClass="tabs" StaticHoverStyle-BackColor="#f1f1f1"
            ...
            <Items>
                ...
                <asp:MenuItem NavigateUrl="~/pages/Currencies.aspx" Selected="true" Text="Currency" Value="Currency"></asp:MenuItem>
        ...
        <div class="container">
                ...
                <table class="full-width" style="margin-top: 10px;">
                    <tr>
                        <td style="width: 25%; vertical-align: top;">
                            <asp:Label runat="server" ID="LblAddCurrencyName" Text="Name"></asp:Label><span class="star"></span></td>
                        <td>
                            <asp:TextBox runat="server" ID="TxtAddCurrencyName" CssClass="input-small" placeholder="Currency Name"></asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ID="CurrencyNameValidator" ControlToValidate="TxtAddCurrencyName"
                                ValidationGroup="AddCurrencyValidationGroup" ErrorMessage="Name can't be blank" SetFocusOnError="true"
                                CssClass="val-msg"></asp:RequiredFieldValidator>
                        </td>
                        <td style="width: 25%; vertical-align: top;">
                            <asp:Label runat="server" ID="LblAddCurrencyCountry" Text="Country"></asp:Label><span class="star"></span></td>
                        <td>
                            <asp:DropDownList runat="server" ID="DDLAddCurrencyCountry" CssClass="input-small">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="CurrencyCountryValidator" ControlToValidate="DDLAddCurrencyCountry"
                                InitialValue="0" ValidationGroup="AddCurrencyValidationGroup" ErrorMessage="Please select a country" SetFocusOnError="true"
                                CssClass="val-msg"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td style="vertical-align: top;">
                            <asp:Label runat="server" ID="LblAddCurrencyPVR" Text="Point-Value Rate"></asp:Label></td>
                        <td>
                            <asp:TextBox runat="server" ID="TxtAddCurrencyPVR" CssClass="input-small" placeholder="Point-Value Rate"></asp:TextBox></td>
                        <td style="vertical-align: top;">
                            <asp:Label runat="server" ID="LblAddCurrencyUSD" Text="USD Rate"></asp:Label></td>
                        <td>
                            <asp:TextBox runat="server" ID="TxtAddCurrencyUSD" CssClass="input-small" placeholder="USD Rate"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: top;">
                            <asp:Label runat="server" ID="LblAddCurrencyISO" Text="ISO"></asp:Label></td>
                        <td>
                            <asp:TextBox runat="server" ID="TxtAddCurrencyISO" CssClass="input-small" placeholder="ISO"></asp:TextBox></td></tr>
                    <tr>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td style="text-align: right; padding: 4px 0px 4px 4px;">
                            <asp:Button runat="server" ID="BtnInsertCurrency" Text="+ Add" Style="margin-right: 10px;" CssClass="btn" ValidationGroup="AddCurrencyValidationGroup" OnClick="BtnInsertCurrency_Click" />
                        </td>
                    </tr>
                </table>
            </div>
            <div class="panel half-width float-right" style="margin-top: 30px; height: 149px;">
                ...
                <table class="full-width no-padding" style="margin-top: 10px;">
                    <tr>
                        <td>Import</td>
                        <td>
                            <asp:FileUpload ID="FileUpload1" runat="server" CssClass="input-small" Width="100%" />
                            <asp:RequiredFieldValidator runat="server" ValidationGroup="FileGroup" ID="RequiredFieldValidator1" ControlToValidate="ImportFileUpload" ErrorMessage="* Please choose a file..."
                                SetFocusOnError="true" CssClass="val-msg"></asp:RequiredFieldValidator>
                        </td>
                        <td style="padding: 0;">
                            <asp:Button ID="Button1" runat="server" CssClass="btn float-right" Text="Import" Width="98%" Height="25px" /></td>
                    </tr>
                    <tr>
                        <td></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button runat="server" ID="Button2" CssClass="btn float-right" Width="98%" Text="Export File" />
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <asp:GridView ID="GVCurrency" CssClass="myGridClass" DataKeyNames="ID,Country" AlternatingRowStyle-CssClass="myAltRowClass"
                PagerStyle-CssClass="myPagerClass" runat="server" AutoGenerateColumns="False" OnRowCancelingEdit="GVCurrency_RowCancelingEdit" OnRowDeleting="GVCurrency_RowDeleting" OnRowEditing="GVCurrency_RowEditing" OnRowUpdating="GVCurrency_RowUpdating" OnRowDataBound="GVCurrency_RowDataBound">
                <Columns>
                    <asp:TemplateField HeaderText="ID">
                        <ItemTemplate>
                            <asp:Label ID="LblCurrencyID" runat="server" Text='<%# Bind("ID") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Name">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtCurrencyName" CssClass="input-small" runat="server" Text='<%# Bind("Name") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="LblCurrencyName" runat="server" Text='<%# Bind("Name") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Country">
                        <EditItemTemplate>
                            <asp:DropDownList ID="DDLCurrencyCountry" runat="server" CssClass="input-small">
                    ...
                    <asp:TemplateField HeaderText="Point-Value Rate">
                        <EditItemTemplate>
                            <asp:TextBox ID="TxtCurrencyPVR" CssClass="input-small" runat="server" Text='<%# Bind("PointValue_Rate") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="LblCurrencyPVR" runat="server" Text='<%# Bind("PointValue_Rate") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="USD Rate">
                        <EditItemTemplate>
                            <asp:TextBox ID="TxtCurrencyUSD" CssClass="input-small" runat="server" Text='<%# Bind("USDRate") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="LblCurrencyUSD" runat="server" Text='<%# Bind("USDRate") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="ISO">
                        <EditItemTemplate>
                            <asp:TextBox ID="TxtCurrencyISO" CssClass="input-small" runat="server" Text='<%# Bind("ISO") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="LblCurrencyISO" runat="server" Text='<%# Bind("ISO") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
